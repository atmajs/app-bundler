...
class CommonJsParser extends BaseParser_1.BaseParser {
    async transpile(content, resource) {
    ...
    async createOutputItems(parent, resource) {
        ...
        if (((_a = resource.dependencies) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            ...
            (0, alot_1.default)(resource.dependencies)
                ...
                relativePath = (0, path_1.path_changeExtension)(relativePath, null);
        ...
        function rewriteUrls(content, rewriteToRelativeUrls) {
