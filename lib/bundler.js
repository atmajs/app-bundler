...
class Resource {
    constructor(includeData, parent, solution) {
        ...
        if (Include_1.Include.PathResolver.isNpm(includeData.url)) {
            ...
            let byNpmResolver = npm_1.Npm.resolveAppUrl(includeData.url, parent && parent.location, solution.opts.base);
...
function nodeModuleResolve(path, location_) {
    ...
    while (true) {
        let nodeModules = (0, path_1.path_combine)(current, '/node_modules/' + name + '/');
...
exports.Builder = {
    build(resources, solution) {
        ...
        function rewriteDependenciesInternal(resources) {
            ...
            return (0, async_1.async_whenAll)(promises);
        }
