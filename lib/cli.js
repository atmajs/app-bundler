...
function path_toRelative(path, anchor, base) {
    var pathNormalized = path_normalize(path);
    var anchorNormalized = path_normalize(anchor);
    var path_ = path_resolveUrl(pathNormalized, base);
    var absolute_ = path_resolveUrl(anchorNormalized, base);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, appcfg_1.default.fetch(sources)];
                    case 1:
                        config = _a.sent();
                        return [2 /*return*/, config.toJSON()];
                    case 2:
                        error_1 = _a.sent();
                        console.error('Configuration error', error_1.message);
                        process.exit(1);
                        return [3 /*break*/, 3];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        json = _a.sent();
                        if (!json.config) return [3 /*break*/, 3];
                        return [4 /*yield*/, doLoad([{ path: json.config }])];
...
module.exports = function run() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Config.load()];
                case 1:
                    config = _a.sent();
                    return [2 /*return*/, Runner_1.Runner.run(config)];
            }
        });
    });
};
